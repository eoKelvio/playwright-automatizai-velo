...
5. Vá em **Project Settings → General** e copie o **Reference ID**

### 2. Variáveis de Ambiente

Crie o arquivo `.env` dentro de `app/`:
...
> Os comandos abaixo devem ser rodados dentro da pasta `app/`

```bash
# Login no Supabase
npx supabase login

# Vincular ao projeto (substitua pelo seu Reference ID)
